(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function o(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(n){if(n.ep)return;n.ep=!0;const r=o(n);fetch(n.href,r)}})();function v(){const t={user:JSON.parse(localStorage.getItem("user"))||null,isLoggedIn:localStorage.getItem("isLoggedIn")==="true"},e={};function o(s){return t[s]}function a(s,i){if(t[s]=i,s==="user"){if(!i){localStorage.removeItem("user");return}localStorage.setItem("user",JSON.stringify(i))}s==="isLoggedIn"&&localStorage.setItem("isLoggedIn",i?"true":"false"),r(s)}function n(s,i){e[s]||(e[s]=[]),e[s].push(i)}function r(s){e[s]&&e[s].forEach(i=>i())}return{getState:o,setState:a,subscribe:n}}const l=v(),y="/front_5th_chapter1-1",g=()=>{const t=window.location.pathname,e=window.location.hash,o=y;return e.includes("#")?e.slice(1):t.startsWith(o)?t.replace(o,"")||"/":t||"/"},w=()=>{const t=l.getState("isLoggedIn"),e="/front_5th_chapter1-1",o=g();return`
  ...
  `),h=[{path:"/",component:E,requiresAuth:!1},{path:"/login",component:A,requiresAuth:!1},{path:"/profile",component:_,requiresAuth:!0}],f=document.getElementById("root"),d="/front_5th_chapter1-1",c=()=>{const t=g(),e=l.getState("isLoggedIn");if(t==="/login"&&e){window.history.pushState({},"",`${d}/`),m("/");return}let o=h.find(a=>a.path===t);if(o&&o.requiresAuth&&!e){window.history.pushState({},"",`${d}/login`),m("/login");return}o?f.innerHTML=o.component():f.innerHTML=F(),x()},m=t=>{const e=h.find(o=>o.path===t);e&&(f.innerHTML=e.component(),x())},H=()=>{document.querySelectorAll("a").forEach(t=>{t.addEventListener("click",e=>{const o=t.getAttribute("href");!o||o.startsWith("http")||o.startsWith("#")||(e.preventDefault(),u(o))})})},u=t=>{let e=t;t.startsWith("/")&&!t.startsWith(d)&&(e=`${d}${t}`),window.history.pushState({},"",e),c()},O=()=>{H(),window.addEventListener("hashchange",c),c()},x=()=>{T(),q(),D()},T=()=>{const t=document.getElementById("login-form");t&&t.addEventListener("submit",e=>{e.preventDefault();const a={username:document.getElementById("username").value,email:"",bio:""};l.setState("isLoggedIn",!0),l.setState("user",a),u("/profile")})},q=()=>{const t=document.getElementById("logout");t&&t.addEventListener("click",e=>{e.preventDefault(),l.setState("isLoggedIn",!1),l.setState("user",null),u("/login")})},D=()=>{const t=document.getElementById("profile-form");t&&t.addEventListener("submit",e=>{e.preventDefault();const o=document.getElementById("username").value,a=document.getElementById("email").value,n=document.getElementById("bio").value,r={username:o,email:a,bio:n};l.setState("user",r),alert("프로필이 업데이트되었습니다.")})};l.subscribe("isLoggedIn",c);window.addEventListener("popstate",c);window.goTo=function(t){u(t)};O();
