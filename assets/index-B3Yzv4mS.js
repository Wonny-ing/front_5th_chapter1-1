(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function o(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(n){if(n.ep)return;n.ep=!0;const r=o(n);fetch(n.href,r)}})();function x(){const t={user:JSON.parse(localStorage.getItem("user"))||null,isLoggedIn:localStorage.getItem("isLoggedIn")==="true"},e={};function o(s){return t[s]}function a(s,i){if(t[s]=i,s==="user"){if(!i){localStorage.removeItem("user");return}localStorage.setItem("user",JSON.stringify(i))}s==="isLoggedIn"&&localStorage.setItem("isLoggedIn",i?"true":"false"),r(s)}function n(s,i){e[s]||(e[s]=[]),e[s].push(i)}function r(s){e[s]&&e[s].forEach(i=>i())}return{getState:o,setState:a,subscribe:n}}const l=x(),v="/front_5th_chapter1-1",m=()=>{const t=window.location.pathname,e=window.location.hash,o=v;return e.includes("#")?e.slice(1):t.startsWith(o)?t.replace(o,"")||"/":t||"/"},y=()=>{const t=l.getState("isLoggedIn"),e="/front_5th_chapter1-1",o=m();return`
